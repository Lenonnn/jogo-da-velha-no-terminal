...
public class Humano extends Jogador {
	...
	@Override
	public void jogar(Tabuleiro tabuleiro) {// personaliza o metodo para jogador humano
		Tentativa(tabuleiro);
		tabuleiro.setPosicao(tentativa, jogador);
	}

	@Override
	public void Tentativa(Tabuleiro tabuleiro) {// personaliza o metodo para jogador humano
		do {
			do {
